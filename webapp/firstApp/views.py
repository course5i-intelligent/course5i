...
import json
import pandas as pd
#from .models import medicine123
import psycopg2
...
def result(request):
    ...
    #b=medicine123(age=request.GET['age'],sex=request.GET['sex'],bmi=request.GET['bmi'],children=request.GET['children'], smoker=request.GET['smoker'], region=request.GET['region'],charges=answer)
    #b.save()
